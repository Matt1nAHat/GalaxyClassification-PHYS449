...
def main():
    ...
    train_df.iloc[:, 0].to_csv('dataAcquisition/Split_data_IDs/train_85k.csv', index=False)
    valid_df.iloc[:, 0].to_csv('dataAcquisition/Split_data_IDs/valid_85k.csv', index=False)
    test_df.iloc[:, 0].to_csv('dataAcquisition/Split_data_IDs/test_85k.csv', index=False)
