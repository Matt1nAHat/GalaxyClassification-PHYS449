...
if __name__ == "__main__":
    ...
    # ET arguments
    parser.add_argument('--DEPTH', type=str, default=5, help='The max depth; can be an int or a list of ints')
    parser.add_argument('--NUM_OF_TREES', type=int, default=70, help='The number of trees in the forest')
